...
import com.trungbao.honestmockingbird.model.HotNewsLab;
...
//        setRetainInstance(true);
        ...
        Log.i(TAG, "HotNewsListFragment created");
    }
    ...
    private void refreshNewsList() {
        // HotNewsLab refresh to null
        // mAdapter point to newsList in HotNewsLab
        HotNewsLab.refresh();
        mAdapter = null;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new HotNewsListFragment.OnSwipeRefreshListener());
    ...
    private void updateUI() {
        HotNewsLab newsLab = HotNewsLab.get(getActivity());
        List<News> newsList = newsLab.getNewsList();

        if (mAdapter == null) {
            mAdapter = new HotNewsListFragment.NewsAdapter(newsList);
    ...
    private class NewsAdapter extends RecyclerView.Adapter<HotNewsListFragment.NewsHolder>{
        ...
        @Override
        public HotNewsListFragment.NewsHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            LayoutInflater inflater = LayoutInflater.from(getActivity());
            return new HotNewsListFragment.NewsHolder(inflater, parent);
        }

        @Override
        public void onBindViewHolder(HotNewsListFragment.NewsHolder holder, int position) {
    ...
    private class NewsHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void bind(News n) {
            ...
            mFactBtn.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    new HotNewsListFragment.VoteTask().execute(mNews, SharedInfo.FACT_VOTE);
            ...
            mOpinionBtn.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    new HotNewsListFragment.VoteTask().execute(mNews, SharedInfo.OPINION_VOTE);
            ...
            mHoldBtn.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    new HotNewsListFragment.VoteTask().execute(mNews, SharedInfo.HOLD_VOTE);
            ...
            mBuyBtn.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    new HotNewsListFragment.VoteTask().execute(mNews, SharedInfo.BUY_VOTE);
            ...
            mSellBtn.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    new HotNewsListFragment.VoteTask().execute(mNews, SharedInfo.SELL_VOTE);
            ...
            mVoteUpBtn.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    new HotNewsListFragment.VoteTask().execute(mNews, SharedInfo.UP_VOTE);
            ...
            mVoteDownBtn.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    new HotNewsListFragment.VoteTask().execute(mNews, SharedInfo.DOWN_VOTE);
    ...
    private class FetchDataTask extends AsyncTask<Object,Void, Integer> {
        ...
        protected Integer doInBackground(Object... params) {
            ...
            double score = (double) params[1];
            int newsCount = (int) params[2];
            int resultType = (int) params[3];

            HotNewsLab.get(context).fetchHotNews(score, newsCount);
